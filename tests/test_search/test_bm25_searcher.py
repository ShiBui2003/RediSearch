...
def _seed_and_build(raw_store, processed_store, index_version_store, tmp_path, db_path):
...
def test_search_returns_ranked_hits(
    ...
    _seed_and_build(raw_store, processed_store, index_version_store, tmp_path, db_path)
